...
<html lang="en">
    <head>
        ...
        <title>Tableau de bord - BJ Admin</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            ...
            <!-- Navbar Search--><div class="bg-default "> </div>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link text-decoration-none" href="Textes.php">Total: <?php $nb=$cptext->fetchColumn(); echo $nb; ?></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                </table><div><td><a class="btn btn-primary" href="ajoutText.php"><span class="glyphicon glyphicon-plus"><span>Ajouter</a></div>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; BJTEXT 2021</div>
                            <div>
