...
<html lang="en">
    <head>
        ...
        <title>ModifTexTe - SB Admin</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">BJTEXT Admin</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Modification de texte</h1>
                        <ol class="breadcrumb mb-4 ">
                            <li class="breadcrumb-item"><a href="index.php" class="text-decoration-none">Tableau de bord</a></li>
                            <li class="breadcrumb-item active">Modification de texte</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                Modifier un texte
                                <form method="post" action="" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="inputTitre" name="titre" value="<?php echo $tr;?>" type="text" placeholder="titre" autofocus required/>
                                        <label for="inputTitre">Titre</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputMot_clé" name="motClé" value="<?php echo $mo;?>"type="text" placeholder="mot-Clé" required />
                                        <label for="inputMot_clé">Mot-Clé</label> 
                                        <!--iinput type="hidden" name="id" value="<--?php $id=$_GET['id']; echo $id;?>"/>
                                        <nput type="hidden" name="fichier" value="<--?php $fichier=$_GET['fichier']; echo $fichier;?>"/-->
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputDescription" name="descrip" value="<?php echo $desc;?>"type="text" placeholder="description" required />
                                        <label for="inputDescription">Description</label>
                                    </div>
                                    <div class="form-control inverse mb-3">                                       
                                        <label >Fichier pdf</label>
                                        <input class=" form-floating " id="inputPdf" name="pdf" value="<?php echo $pdf;?>"type="file" placeholder="" />
                                    </div> 
                                    ...
                                    <?php 
                                      foreach($categories as $nom){
                                        ...
                                        echo'<input type="radio" class="custom-control-input" id="'.$nom['categories_id'].'" name="radio"';
                                       /* if($nom['categories_libelles']==$caorie){echo 'checked';}*/ echo'value="'.$nom['categories_libelles'].'" required>';
                                       ...
                                       <span class="col-xl-2 btn btn-default" style="border:solid silver 1px;">
                                        <input type="radio" class="custom-control-input" id="comptabilite" name="radio" value="comptabilite" required>
                                    ...
                                    <div class="row align-items-center text-center justify-content-center  mt-4 mb-0">
                                        <span class="text-danger text-bolder-bold"><?php echo $Error ; ?></span></div>                                    
                                    <div class="row align-items-center text-center justify-content-center  mt-4 mb-0">
                                       <input class="btn btn-primary  col-xl-4" type="submit" name="submit" value="Modifier">
                                    </div>
