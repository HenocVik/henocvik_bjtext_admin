...
<html lang="fr">
   <head>
      <title>BJTEXT &mdash;Website Template by Colorlib</title>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <link href="https://fonts.googleapis.com/css?family=Raleway:300,400,700&amp;display=swap" rel="stylesheet">
      <link rel="stylesheet" href="/bjtext/asset/css/css.min.css" />
  </head>
   <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
         ...
         <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
            <div class="container">
               <div class="row align-items-center position-relative">
                  <div class="site-logo">
                     <a href="index-2.html" class="text-black"><span class="text-primary">BJTEXT</a>
                  </div>
                  <div class="col-12">
                     <nav class="site-navigation text-right ml-auto " role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                           <li><a href="#home-section" class="nav-link">Benin</a></li>
                           <li><a href="#services-section" class="nav-link">Ac</a></li>
                           <li>
               ...
               <div class="container">
                  <div class="owl-carousel owl-all">
                     <div class="service text-center">
                        <a href="#"><img src="/bjtext/asset/images/depot_img_1.jpg" alt="Image" class="img-fluid"></a>
                        <div class="px-md-3">
            ...
            <div class="block__73694 site-section border-top" id="why-us-section">
               <div class="container">
                  <div class="row d-flex no-gutters align-items-stretch">
                     <div class="col-12 col-lg-6 block__73422 order-lg-2" style="background-image: url('images/depot_delivery_1.jpg');" data-aos="fade-left" data-aos-delay=""></div>
      ...
      <script src="js/popper.min.js%2bbootstrap.min.js.pagespeed.jc.5jBm_S-jZO.js"></script><script>eval(mod_pagespeed_vlDYzScndM);</script>
      <script>eval(mod_pagespeed_YjJV9Zec0X);</script>
      <script src="js/owl.carousel.min.js%2bjquery.sticky.js%2bjquery.waypoints.min.js%2bjquery.animateNumber.min.js.pagespeed.jc.8wzactwMFt.js"></script><script>eval(mod_pagespeed_5Itp8KFPL5);</script>
      ...
      <script src="js/jquery.fancybox.min.js%2bjquery.easing.1.3.js%2baos.js.pagespeed.jc.WlBefT-D6w.js"></script><script>eval(mod_pagespeed_WRgVH4byVZ);</script>
